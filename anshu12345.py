...
BOT_TOKEN = os.getenv("8658924202:AAGlaypnLN7XtUi4_BPLy6axRrgE_nFOZOA", "PUT_YOUR_BOT_TOKEN_HERE")        # e.g. "123456789:AAExampleTokenFromBotFather"
CHANNEL_ID = os.getenv("-1004309680225", "PUT_YOUR_CHANNEL_ID_HERE")     # e.g. "-1001234567890" (your private admin/orders channel)
ADMIN_ID = int(os.getenv("6644342214", "0"))                            # e.g. 5551234567 — your numeric Telegram user id

UPI_ID = os.getenv("8303721228@ibl", "yourupi@bank")                          # your real UPI ID shown to buyers
...
# ====== PRODUCTS (ALL ₹50) ======
PRODUCTS = {
    "py": {"name": "🐍 Python Script", "price_inr": 50},
    "java": {"name": "☕ Java Program", "price_inr": 50},
    "cpp": {"name": "⚙️ C++ Code", "price_inr": 50},
    "js": {"name": "🟨 JavaScript Code", "price_inr": 50},
    "html": {"name": "🌐 HTML/CSS Website", "price_inr": 50},
    "php": {"name": "🐘 PHP Script", "price_inr": 50},
}
